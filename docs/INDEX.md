...
| Document                                             | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [org-graph.md](org-graph.md)                         | **The organizational graph**: the ontology (4 labels, 6 relations, no reports-to and why), which rules Neo4j Community can enforce and which the app has to, the one authorised wipe vs the idempotent setup path, the app-only Graph roster ingest and its exclusions, why Teams are blocked on a tenant permission, the roster as a pseudonymisation mapping source, and (§8) the first edge-inference lane — role/department groupings and shared-mailbox reclassification, provenance-tagged and idempotent, plus the M365-scope gap blocking a second, evidence-based half |
