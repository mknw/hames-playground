...
> A raw bound function (`b.LoopController.bind(b)`) does NOT satisfy a
> pattern's controller contract and fails typecheck. The decision and the
> wrapper-layer rationale itself are unchanged.
