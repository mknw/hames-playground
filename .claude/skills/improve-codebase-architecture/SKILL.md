...
<!-- Vendored from mattpocock/skills (MIT © 2026 Matt Pocock), skills/engineering/improve-codebase-architecture/SKILL.md.
...
Read the project's domain glossary (`GLOSSARY.md`) and any ADRs in the area you're touching first. If either is missing, say so and carry on.
