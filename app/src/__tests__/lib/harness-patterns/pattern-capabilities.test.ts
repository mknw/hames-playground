 ...
 * combinators) and flags a leaf by its structural signature: a `retriever`'s
 * patternId + `backendKinds`, or the `sandboxSyncWorkspace` marker
 * `withSandbox({ syncWorkspace: true })` stamps.
 *
